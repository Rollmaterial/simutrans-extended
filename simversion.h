...
#define VERSION_NUMBER "Extended" SIM_VERSION_BUILD_STRING " "
#define EXTENDED_VERSION QUOTEME(EX_VERSION_MAJOR) "." QUOTEME(EX_VERSION_MINOR) "." QUOTEME(EX_SAVE_MINOR)
